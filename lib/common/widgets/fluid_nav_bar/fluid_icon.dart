...
class FluidFillIcon extends StatelessWidget {
  ...
  FluidFillIcon(this._context,FluidFillIconData iconData, double fillAmount, double scaleY)
      : _iconData = iconData, _fillAmount = fillAmount, _scaleY = scaleY;

  @override
  Widget build(context) {
    return CustomPaint(
        painter: _FluidFillIconPainter(_iconData.paths, _fillAmount, _scaleY,_context),
    );
  }
}
...
class _FluidFillIconPainter extends CustomPainter {
  ...
  _FluidFillIconPainter(List<ui.Path> paths, double fillAmount, double scaleY,this._context)
  ...
  void paint(canvas, size) {
    final paintBackground = Paint()
        ...
        ..color = Theme.of(_context).iconTheme.color.withOpacity(0.6);
    ...
    final paintForeground = Paint()
        ...
        ..strokeCap = StrokeCap.round
        ..strokeJoin = StrokeJoin.round
        ..color = Theme.of(_context).iconTheme.color;
